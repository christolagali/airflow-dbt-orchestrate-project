...
execute_dbt_model = BashOperator(
                 ...
                 bash_command=f"""dbt run --profiles-dir {DBT_CONNECTION_PATH} --project-dir {DBT_PROJECT_PATH} --select tpch_execution_modes --vars '{{execution_mode: partial_refresh, refresh_year: 1993 }}' """
                 )
